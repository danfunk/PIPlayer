define(['require','jquery','underscore','utils/pubsub','utils/interface/interface','app/stimulus/stimulus_collection','./interactions','./current_trial','../inflator','app/task/main_view'],function(require){
